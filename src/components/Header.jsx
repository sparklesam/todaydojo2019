...
class Header extends Component {
  render() {
    ...
    return (
      <NavBar>
        <a href="http://desktopofsamuel.com/?ref=pins">
          <Button>
            <Icon src={HomeIcon} />
            <NavLink style={{ color: "#95973B" }}>Home</NavLink>
          </Button>
        </a>
        <a href="http://desktopofsamuel.com/work?ref=pins">
          <Button>
            <Icon src={WorkIcon} />
            <NavLink style={{ color: "#49CB74" }}>Work</NavLink>
          </Button>
        </a>
        <a href="http://desktopofsamuel.com/blog?ref=pins">
          <Button>
            <Icon src={BlogIcon} />
            <NavLink style={{ color: "#FE8170" }}>Blog</NavLink>
          </Button>
        </a>
        <a href="http://desktopofsamuel.com/photo?ref=pins">
          <Button>
            <Icon src={PhotoIcon} />
            <NavLink style={{ color: "#3284DC" }}>Aperture</NavLink>
          </Button>
        </a>
        <Link exact to="/" style={{ opacity: "1" }}>
          <Button>
            <Icon src={BookmarkIcon} />
            <NavLink style={{ color: "#6469DA" }}>Pin</NavLink>
          </Button>
        </Link>
      </NavBar>
    );
